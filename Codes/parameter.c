...
int ENTER_1ST_CORNER_VELOCITY_VAL = 150; //
int FIRST_CORNER_VELOCITY_VAL     = 150; //
int SECOND_STRAIGHT_VELOCITY_VAL  = 200; //
int ENTER_2ND_CORNER_VELOCITY_VAL = 150; //
int SECOND_CORNER_VELOCITY_VAL    = 150; //
