...
int FIRST_STRAIGHT_VELOCITY_VAL   = 200; //
int ENTER_1ST_CORNER_VELOCITY_VAL = 200; //
int FIRST_CORNER_VELOCITY_VAL     = 200; //
int SECOND_STRAIGHT_VELOCITY_VAL  = 200; //
int ENTER_2ND_CORNER_VELOCITY_VAL = 200; //
int SECOND_CORNER_VELOCITY_VAL    = 200; //
int THIRD_STRAIGHT_VELOCITY_VAL   = 200; //
int THIRD_CORNER_VELOCITY_VAL     = 200; //
int S_CORNER_VELOCITY_VAL         = 100;
int FOURTH_STRAIGHT_VELOCITY_VAL  = 200; //
int GOAL_VAL                     = 100;

int FOURTH_CORNER_VELOCITY_VAL    = 200; //

int ENTER_5TH_CORNER_VELOCITY_VAL = 100;
int FIFTH_CORNER_VELOCITY_VAL     = 200; //
int SIXTH_CORNER_VELOCITY_VAL     = 200; //
int SEVENTH_CORNER_VELOCITY_VAL     = 200; //
int EIGHTH_CORNER_VELOCITY_VAL     = 200; //
int NINTH_CORNER_VELOCITY_VAL     = 200; //
int TENTH_CORNER_VELOCITY_VAL     = 200; //
